function searchAndDisplay() {
    ...
    var matchingTextList = []; // Create a list to store matching text
    ...
    while (textNodes.nextNode()) {
        ...
        if (textContent.includes(searchText)) {
            ...
            matchingTextList.push(textContent); // Add matching text to the list
        }
    }
    ...
    if (!foundMatchingText) {
        ...
        // If matching text was found, show a success SweetAlert with the list of matching text
        Swal.fire({
            icon: 'success',
            title: 'Found Text Matching',
            html: matchingTextList.join('<br>') // Display the matching text in the pop-up
        });
    }
}
